export default {
  ...
  plugins: [
    ...
    {
      name: 'removeUnknownsAndDefaults',     // удаляет inkscape:, ns1:*, _svgfile__*, …
      params: {
        unknownContent:  true,               // неизвестные элементы
        unknownAttrs:    true,               // неизвестные атрибуты
        defaultAttrs:    true,               // атрибуты со значением по-умолчанию
        keepDataAttrs:   true,               // но data-* оставляем
        keepAriaAttrs:   true                // …и aria-*, если нужны для a11y
      }
    },
    { name: 'removeUnusedNS' },
    { name: 'removeXMLNS' },
